...
# Qwen3.8-27B-AWQ-INT4 vLLM restart (RTX8000 GPU1 TP=1, awq_marlin, MTP3, MULTIMODAL image)
...
LOG=run-logs/vllm-rtx8000-qwen38-27b-awq-int4-mm-$(date +%Y%m%d-%H%M%S).log
