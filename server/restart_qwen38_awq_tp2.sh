...
# Qwen3.8-27B-AWQ-INT4 vLLM restart (RTX8000 GPU0+1 TP=2, awq_marlin, MTP3, MULTIMODAL image)
...
LOG=run-logs/vllm-rtx8000-qwen38-27b-awq-int4-tp2-$(date +%Y%m%d-%H%M%S).log
